...
QT_MOC_LITERAL(3, 13, 9), // "destroyed"
QT_MOC_LITERAL(4, 23, 4), // "move"
QT_MOC_LITERAL(5, 28, 4) // "grow"

    },
    "Snake\0moved\0\0destroyed\0move\0grow"
};
...
void Snake::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Snake::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Snake::moved)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Snake::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Snake::destroyed)) {
                *result = 1;
                return;
            }
        }
